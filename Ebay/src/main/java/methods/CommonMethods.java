...
public class CommonMethods extends CommonAPI {
    ...
    public void eBaySearchBar() throws InterruptedException {

        ConnectDB connectDB = new ConnectDB();

        List<String> list = new ArrayList<String>();

        list = connectDB.retrieveDataFromTable("select searchitems from tosearch", "searchitems");



        searchBar.sendKeys(list.get(0));
